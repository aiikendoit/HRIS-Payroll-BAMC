...
//#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Degreetype>(entity =>
        {
            ...
            entity.Property(e => e.PkDegreetype)
                .ValueGeneratedNever()
                .HasColumnName("PK_degreetype");
        ...
        modelBuilder.Entity<Disciplinarytype>(entity =>
        {
            ...
            entity.Property(e => e.PkDisciplinarytype)
                .ValueGeneratedNever()
                .HasColumnName("PK_disciplinarytype");
            entity.Property(e => e.Createdby).HasColumnName("createdby");
            entity.Property(e => e.Createddate)
                .HasColumnType("datetime")
                .HasColumnName("createddate");
        ...
        modelBuilder.Entity<Employee>(entity =>
        {
            ...
            entity.Property(e => e.Tinno)
                ...
                .IsUnicode(false)
                .HasColumnName("tinno");
            entity.Property(e => e.FkZipcode).HasColumnName("zipcode");
